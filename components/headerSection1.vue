<template>
    <div id="section1">
      <div class="langCurrency">
          <div @click="changeLanguage" class="lang">
              ...
              <div id="langMenu">
                  <ul>
                      ...
                      <li @click="languageSelected('per')">پارسی</li>
                  </ul>
              </div>
          </div>
          <div @click="changeCurrency">
              ...
              <div id="currencyMenu">
                  <ul>
                      <li @click="currencySelected('euro')"><v-icon small>mdi-currency-eur</v-icon>یورو</li>
                      <li @click="currencySelected('toman')"><v-icon small>mdi-currency-usd</v-icon>تومان</li>
                      <li @click="currencySelected('dollar')"><v-icon small>mdi-currency-usd</v-icon>دلار</li>
                  </ul>
              </div>
          </div>
      </div>
      <div class="shipMess">ارسال همین امروز - پشتیبانی (021-4683609)</div>
    </div>
  </template>
  ...
  export default {
      ...
      mounted(){
        if(this.$store.getters.getLanguage == 'per')
